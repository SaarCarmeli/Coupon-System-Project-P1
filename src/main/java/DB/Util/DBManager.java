...
public class DBManager {
    ...
    public static final String UPDATE_COUPON_BY_ID = "UPDATE coupons SET title = ?, category = ? ,amount = ? ," + "description = ? ,price = ? ,image = ? , start_date = ? ,end_date = ? WHERE id = ?";
    ...
    public static final String UPDATE_CUSTOMER_BY_ID = "UPDATE customers SET first_name = ?,last_name = ?, email = ?, password = ? WHERE id = ?";
